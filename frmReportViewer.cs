    ...
    public partial class frmReportViewer : Form
    {
        ...
        private void frmReportViewer_Load(object sender, EventArgs e)
        {
            ...
            if (_Report == null)
            {
                ...
                // this.reportViewer1.LocalReport.SetParameters(new ReportParameter("Titulo", Parametros.ParametrosSucursal.EncabezadoFactura1));
                ...
                this.reportViewer1.LocalReport.SetParameters(new ReportParameter("Titulo", "Administracoin de Apartamento MK-6"));

                if (sTitulo2 != "")
                {
                    this.reportViewer1.LocalReport.SetParameters(new ReportParameter("Titulo2", sTitulo2));
                }
